...
const ADMIN_CATALOG: NavCatalog = {
  ...
  items: [
    ...
    { id: "listings", label: "New Listings", icon: "🏡", group: "sales" },
    { id: "brokerages", label: "Brokerage Partners", icon: "🤝", group: "sales" },
    { id: "lead-routing", label: "Lead Routing", icon: "🗺️", group: "sales" },
    { id: "lead-playbooks", label: "Outreach Notes", icon: "📣", group: "sales" },
    { id: "coach", label: "Sales Coach", icon: "🎓", group: "sales" },
    { id: "guide", label: "Sales Guide", icon: "📕", group: "sales" },
...
const PORTAL_CATALOG: NavCatalog = {
  ...
  items: [
    ...
    { id: "sales-dashboard", label: "Sales Dashboard", icon: "🏁", group: "main" },
    { id: "leads", label: "Leads", icon: "🎯", group: "main" },
    { id: "listings", label: "New Listings", icon: "🏡", group: "main" },
    { id: "brokerages", label: "Brokerage Partners", icon: "🤝", group: "main" },
    { id: "coach", label: "Sales Coach", icon: "🎓", group: "main" },
    { id: "guide", label: "Sales Guide", icon: "📕", group: "main" },
